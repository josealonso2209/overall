...
<footer class="footer container-fluid">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 mb-5 mb-lg-0 text-center">
                <div>
                    <h4 class="text-uppercase mb-4">OVERALL</h4>
                    <div>
                        <ul>
                            <li><strong>Dirección:</strong> Calle #123,<br>Santa Marta, Colombia</li>
                            <li><strong>Email:</strong> contacto@overall.co</li>
                            <li><strong>Teléfono:</strong> (+57) 5555555</li>
                            <li></li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <ul>
                <li><p class="copyright-2 text-center">Copyright © 2020 OverAll.</p></li>
                <li>
                ...
                <li><p class="copyright-2 text-center" ><a href="#" target="_blank"><i class="fas fa-code"></i> Hecho con <i class="fas fa-heart"></i> en Colombia</a></p></li>
            </ul>
        </div>
    </div>
</footer>